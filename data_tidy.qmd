...
db %>% 
  ...
  radarchart(title = "Media del HDMI por continentes", cglty = 1, cglcol = "gray",
           pcol = 4, plwd = 2,
...
db %>% 
  ...
  radarchart(title = "Media de la producción de CO2 por continentes", cglty = 1, cglcol = "grey",
           pcol = 2, plwd = 2,
...
db %>% 
  ...
  radarchart(title = "Media del PIB por continentes", cglty = 1, cglcol = "grey",
           pcol = 3, plwd = 2,
...
db %>% 
  ...
  radarchart(title = "Media de la esperanza de vida por continentes", cglty = 1, cglcol = "grey",
           pcol = 7, plwd = 2,
...
db %>% 
  ...
  radarchart(title = "Media de la población por continentes", cglty = 1, cglcol = "grey",
           pcol = 14, plwd = 2,

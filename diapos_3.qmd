...
-   Hemos convertido las variables *Continente* y *HDI_level* en factores. La segunda de ellas ordenado.
...
- 2 variables ordinales: _HDI_rank_, _HDI_level_.
- 2 variables nominales: _Country_, _Continent_.
- 5 variables cuantitativas:  _HDI_, _CO2_prod_, _GNIPC_, _Life_expect_, _Population_.

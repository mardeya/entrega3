...
Hemos encontrado nuestra fuente de datos en este  [enlace](https://www.kaggle.com/datasets/toriqulstu/global-socio-economic-and-environmental-indicators) de la página web de _kaggle_
...
El objetivo de nuestro estudio es encontrar relaciones entre los indicadores sociales, econónimos y ambientales de los diferentes países de nuestro planeta. Además, queremos estudiar las diferencias entre los distintos continentes.

<div style="text-align:center;">
![](imagen2.jpg){width=80%}
</div>
...
- Hemos juntado las 6 tablas usando la función _left_join_ gracias a la clave primaria _ISO3_
- Hemos convertido las variables _Continente_ y _HDI_level_ en factores. La segunda de ellas ordenado
